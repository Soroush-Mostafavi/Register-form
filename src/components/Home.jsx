...
const Home = () => {
  return (
    ...
    <header className="masthead mb-auto">
      <div className="inner">
        <Tooltip title="this app build with functional components //
        ...
        this app reaponsive with bootstrap "><h3 className="masthead-brand text-center">Home</h3></Tooltip>
    ...
    <footer class="mastfoot mt-auto">
      ...
      <h1 className="cover-heading "style={{color:"red", marginTop:"100px",fontSize:"20px"}}>Soroush Register Form</h1>
